...
if (isset($_POST['proses'])) {
	...
	if ($jum > 0) {
		...
		echo '<script>alert("Welcome! Please enjoy your work!");window.location="index.php"</script>';
	} else {
...
<head>
	...
	<title>Login - BeGood.Inc & Co</title>
					...
					<div class="card-body p-0">
						...
						<div class="p-5">
							<div class="text-center">
								<h4 class="h4 text-gray-900 mb-4"><b>Login for BeGood.Inc & Co Employees</b></h4>
							</div>
